...
const TopNavbar: React.FC<TopNavbarProps> = ({ brandName }) => {
  return (
    <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white/80 backdrop-blur-xl border-b border-slate-200 z-40 px-6 flex items-center justify-between shadow-sm">
