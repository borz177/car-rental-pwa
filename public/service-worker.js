...
const CACHE_NAME = 'autopro-v5';
// Внешних адресов здесь больше нет: стили, иконки и шрифт собираются в бандл и
// лежат на своём домене в /assets с хешами в именах. Их подхватывает runtime-кэш
// ниже (cache-first для статики), поэтому перечислять их поимённо не нужно —
// имена всё равно меняются при каждой сборке.
const APP_SHELL = [
  '/',
  '/index.html'
];
